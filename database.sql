...
CREATE TABLE IF NOT EXISTS Company_Projects (
    ...
    DisplayOrder INT DEFAULT 0,
    ShowTitle TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowOwner TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowLocation TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowArea TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowValue TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowTurnoverDate TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowCategory TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowDescription TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowImage1 TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    ShowImage2 TINYINT DEFAULT 1 COMMENT '1-show, 0-hide',
    Status TINYINT DEFAULT 1 COMMENT '1-active, 0-inactive',
    CreatedTimestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UpdatedTimestamp TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP,
