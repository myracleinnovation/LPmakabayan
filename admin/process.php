...
// Get total process steps count for display order dropdown
$pdo = Db::connect();
$companyProcess = new CompanyProcess($pdo);
$totalProcess = $companyProcess->getTotalProcess();
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select shadow-none" id="displayOrder" name="display_order">
                                    ...
                                    <?php for($i = 1; $i <= $totalProcess + 10; $i++): ?>
