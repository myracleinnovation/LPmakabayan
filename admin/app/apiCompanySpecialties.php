                ...
                case 'create':
                    try {
                        ...
                        if (isset($_FILES['specialty_image']) && $_FILES['specialty_image']['error'] === UPLOAD_ERR_OK) {
                            ...
                            $result = uploadImage($file, $uploadDir, 'specialty', $nextSpecialtyNumber);
                ...
                case 'update':
                    try {
                        ...
                        if (isset($_FILES['specialty_image']) && $_FILES['specialty_image']['error'] === UPLOAD_ERR_OK) {
                            ...
                            $result = uploadImage($file, $uploadDir, 'specialty', $nextSpecialtyNumber, $currentSpecialty['SpecialtyImage']);
