<?php
    ...
    function processImageUpload($file, $uploadDir, $companyIndustries, $oldImage = null) {
                ...
                case 'create':
                    try {
                        ...
                        if (isset($_FILES['industry_image']) && $_FILES['industry_image']['error'] === UPLOAD_ERR_OK) {
                            $filename = processImageUpload($_FILES['industry_image'], $uploadDir, $companyIndustries);
