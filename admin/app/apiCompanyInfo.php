                ...
                case 'update_company':
                    try {
                        ...
                        if (isset($_FILES['about_image']) && $_FILES['about_image']['error'] === UPLOAD_ERR_OK) {
                            ...
                            $result = uploadImage($file, $uploadDir, 'about', $nextAboutNumber, $currentCompany['AboutImage']);
                        ...
                        if (isset($_FILES['logo_image']) && $_FILES['logo_image']['error'] === UPLOAD_ERR_OK) {
                            ...
                            $result = uploadImage($file, $uploadDir, 'logo', $nextLogoNumber, $currentCompany['LogoImage']);
