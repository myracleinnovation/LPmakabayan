...
// Get total industries count for display order dropdown
$pdo = Db::connect();
$companyIndustries = new CompanyIndustries($pdo);
$totalIndustries = $companyIndustries->getTotalIndustries();
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select shadow-none" id="displayOrder" name="display_order">
                                    ...
                                    <?php for($i = 1; $i <= $totalIndustries + 10; $i++): ?>
